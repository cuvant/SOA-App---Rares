...
Rails.application.config.assets.precompile += %w( dashing/minim_dashing.css )
Rails.application.config.assets.precompile += %w( dashing/minim_dashing.js )
Rails.application.config.assets.precompile += %w( turbolinks-compatibility.js )
