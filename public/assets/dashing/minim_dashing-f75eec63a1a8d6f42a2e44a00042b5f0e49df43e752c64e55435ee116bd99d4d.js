...
(function() {
  ...
  Batman.ViewStore = (function(_super) {
    ...
    // TODO HERE COMMENTED THE GET REQUEST!
    // ViewStore.accessor({
    //   'final': true,
    //   get: function(path) {
    //     var contents;
...
(function() {
  ...
  Dashing.showGridsterInstructions = function() {
    ...
    if (JSON.stringify(newWidgetPositions) !== JSON.stringify(Dashing.currentWidgetPositions)) {
      ...
      $.ajax({
        url: location.protocol + "//" + location.host + "/save_layout/" + window.dashboard_id,
        data: {layout: JSON.stringify(Dashing.currentWidgetPositions)},
      });
      return;
  ...
  // Here is the function that was previously used with "Save Layout Button"
  // $(function() {
